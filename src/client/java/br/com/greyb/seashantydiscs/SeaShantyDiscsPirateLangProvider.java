...
public class SeaShantyDiscsPirateLangProvider extends FabricLanguageProvider {
    public SeaShantyDiscsPirateLangProvider(
            FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> wrapperLookup) {
        super(output, "en_pt", wrapperLookup);
    }

    @Override
    public void generateTranslations(RegistryWrapper.WrapperLookup wrapperLookup, TranslationBuilder translationBuilder) {
        String discName = "Shanty";
